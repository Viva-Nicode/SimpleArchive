//import UIKit
//
//final class FullScreenTextEditorComponentViewAnimator: NSObject, UIViewControllerAnimatedTransitioning {
//
...
//    private let secondViewController: any ProtocolForFullScreenAnimation
//
...
//        secondViewController: any ProtocolForFullScreenAnimation
//    ) {
//        self.type = type
...
//            secondViewController.componentContentViewContainer.convert(secondViewController.componentContentViewContainer.bounds, to: window)
//
...
//            let controllerTextViewSnapshot = secondViewController.getContentView().snapshotView(
//                afterScreenUpdates: true)
//        else {
//            transitionContext.completeTransition(true)
//            return
