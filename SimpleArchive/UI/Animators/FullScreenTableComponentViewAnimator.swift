//import UIKit
//
//final class FullScreenTableComponentViewAnimator: NSObject, UIViewControllerAnimatedTransitioning {
//    
...
//                controllerTextViewSnapshot.removeFromSuperview()
//
//                self.firstViewController.selectedPageComponentCell?.resetupComponentContentViewToDismissFullScreenAnimation()
