...
enum MemoHomeViewOutput {
    ...
    case didNavigateSingleTextEditorComponentPageView(TextEditorComponentViewModel, TextEditorComponent)
    case didNavigateSingleTableComponentPageView(TableComponentViewModel, TableComponent)
    case didNavigateSingleAudioComponentPageView(AudioComponentViewModel, AudioComponent)
