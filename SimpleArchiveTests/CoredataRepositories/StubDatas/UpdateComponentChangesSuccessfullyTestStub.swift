...
final class UpdateComponentChangesSuccessfullyTestStub: StubDatable {
    ...
    private func provideTestTargetInput() -> TestTargetInputType {
        ...
        return PageComponentChangeObject(
            componentIdChanged: testTextEditorComponent.id, title: "after change title", isMinimumHeight: true)
    }
}
