final class DormantBoxCoreDataRepositoryTestFixtureProvider: TestFixtureProvidable {
    typealias TargetTestClassType = DormantBoxCoreDataRepositoryTests
    ...
    init() {
        let fixtures: [any TestFixtureType] = [
            FetchDormantBoxDirectorySuccessfullyTestFixture(),
            RestoreFileSuccessfullyTestFixture(),
        ]
