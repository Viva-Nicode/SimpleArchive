final class DormantBoxCoreDataRepositoryTestStubProvider: TestStubProvidable {
    ...
    init() {
        let stubs: [any StubDatable] = [
            FetchDormantBoxDirectorySuccessfullyTestStub(),
            RestoreFileSuccessfullyTestStub(),
        ]
